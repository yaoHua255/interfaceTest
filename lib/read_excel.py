...
if __name__ == '__main__':
    ...
    data_list = excel_to_list("../data/test_user_data.xlsx", "TestUserReg")  # 读取excel，TestUserLogin工作簿的所有数据
    case_data = get_test_data(data_list, 'test_cxk')  # 查找用例'test_user_login_normal'的数据
    # print(data_list)
    print(case_data)
